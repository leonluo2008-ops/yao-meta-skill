...
| Package Verification | `4 / 4` target adapters present, archive verified, `612` zip entries, `0` nested SKILL.md entries, `0` failures, `0` warnings |
| Install Simulation | archive with `612` entries extracted into a local verification root, `0` nested SKILL.md entries, entrypoint/manifest/interface loaded, reports present, `4` adapters readable, `12` installer permission checks enforced, `0` permission failures, `0` failures, `0` warnings |
